...
// This JS is for bad vh support in css

function heights() {

    var windowHeight = $(window).height();
    var headerMargin = windowHeight*0.95;

    $('#pusher').css('height', headerMargin);
...
$(window).scroll(function() {
    if (!mobilecheck()) {
        $("#header-intro .container").stop().css({"margin-top": -($(document).scrollTop()/5) + "px"});
    }
